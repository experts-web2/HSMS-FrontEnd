...
export class GenericTableComponent {
    ...
    constructor(private readonly datePipe: DatePipe, private confirmationService: ConfirmationService,) { }
    ...
    actionEmitter(data: any, action: string) {
        ...
        if (action === 'delete') {
            this.confirmationService.confirm({
                message: `Are you sure that you want to delete ${data.name??data.firstName} ?`,
